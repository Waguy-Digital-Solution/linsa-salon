/* ============================================================
   [NON BIZNIS OU] — Koneksyon Firebase (baz done pataje)
   ============================================================
   POUKISA: Sa a pèmèt randevou kliyan pran sou paj piblik la
   (public/index.html) parèt otomatikman nan app kès la
   (staff/index.html), menm si se pa menm aparèy/navigatè.

   ⚠️ CHAK NOUVO KLIYAN BEZWEN PWÒP PWOJÈ FIREBASE PA YO — pa janm
   itilize menm konfigirasyon ak yon lòt biznis, sinon done yo ap
   mele nan menm baz done a.

   KIJAN POU KONFIGIRE L (gratis, ~5 minit):
   1. Ale sou https://console.firebase.google.com
   2. "Add project" → bay li yon non (egzanp: non-biznis-la)
   ...
   4. Nan meni goch la tou: Build → Storage → "Get started" (pou ka
      ...
      mande yon kont Blaze/peman, opsyonèl)
   ...
   7. Pouse (push) chanjman an — tou de public/index.html ak
      staff/index.html ap otomatikman konekte ak menm baz done a.
...
const FIREBASE_CONFIG = {
  ...
  storageBucket: "REMPLACE_MWEN.firebasestorage.app",
